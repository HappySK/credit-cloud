...
function drawChart_active_clients() {
  ...
  var chart = new google.visualization.LineChart(document.getElementById('active_clients_chart'));
...
function drawChart_affiliates() {
  ...
  var chart = new google.visualization.BarChart(document.getElementById("affiliates_chart"));
...
function drawChart_clients_success() {
  ...
  var chart = new google.visualization.PieChart(document.getElementById('clients_success_chart'));
