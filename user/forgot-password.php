...
<head>
  ...
  <!--end::Layout Themes-->
  <link rel="shortcut icon" href="assets/dist/ass/media/logos/favicon.ico" />
</head>
<!--end::Head-->
<!--begin::Body-->
...
<body id="kt_body"
    ...
    <div class="login login-4 wizard d-flex flex-column flex-lg-row flex-column-fluid">
          ...
          <div class="login-form">
            <form class="form" id="kt_login_forgot_form" action="">
              ...
              <div class="form-group">
                <input class="form-control form-control-solid h-auto py-7 px-6 border-0 rounded-lg font-size-h6"
              ...
              <div class="form-group d-flex flex-wrap">
                ...
                <a href="custom/pages/login/login-4/signin.html" id="kt_login_forgot_cancel"
      ...
      <div class="login-aside order-1 order-lg-2 bgi-no-repeat bgi-position-x-right">
        <div class="login-conteiner bgi-no-repeat bgi-position-x-right bgi-position-y-bottom"
          style="background-image: url(assets/dist/ass/media/svg/illustrations/login-visual-4.svg);">
          <!--begin::Aside title-->
          <h3
  ...
  <script src="assets/dist/ass/plugins/global/plugins.bundle.js"></script>
