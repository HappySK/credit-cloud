...
<head>
  ...
  <link href="assets/dist/assets/css/pages/login/login-4.css" rel="stylesheet" type="text/css" />
...
<body id="kt_body"
    ...
    <div class="login login-4 wizard d-flex flex-column flex-lg-row flex-column-fluid wizard" id="kt_login">
        ...
        <div class="login-content login-content-signup d-flex flex-column">
          ...
          <div class="d-flex flex-column-auto flex-column px-10">
            ...
            <a href="#" class="login-logo pb-lg-4 pb-10">
              <img src="https://app.creditrepaircloud.com/application/images/creditrepaircloud_logo-small.png"
          ...
          <div class="login-form">
            ...
            <form class="form px-10" novalidate="novalidate" id="kt_login_signup_form">
              ...
              <div class="" data-wizard-type="step-content" data-wizard-state="current">
                ...
                <div class="pb-10 pb-lg-12">
                  ...
                  <div class="text-muted font-weight-bold font-size-h4">Already have an Account ?
                    <a href="user/sign-in" class="text-primary font-weight-bolder">Sign In</a>
                  </div>
                </div>
                <!--begin::Title-->
                <!--begin::Form Group-->
                ...
                <div class="form-group">
                  ...
                  <input type="email" class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0"
                    name="email" id="email" autocomplete="off" placeholder="Your Email ID" required />
                </div>
                <!--end::Form group-->
                <!--begin::Form group-->
                <div class="form-group">
                  ...
                  <input type="password" class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0"
                    name="password" id="password" autocomplete="off" placeholder="Your Password" required />
                </div>
                <!--end::Form group-->
              </div>
              <!--end: Wizard Step 1-->
                ...
                <div class="row">
                  <div class="col-xl-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text"
                        class="form-control form-control-solid h-auto py-7 px-6 border-0 rounded-lg font-size-h6"
                        name="address1" placeholder="Address Line 1" value="" id="address1" />
                  ...
                  <div class="col-xl-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text"
                        class="form-control form-control-solid h-auto py-7 px-6 border-0 rounded-lg font-size-h6"
                        name="address2" placeholder="Address Line 2" value="" id="address2" />
                      <span class="form-text text-muted">Please enter your Address.</span>
                    </div>
                    <!--end::Input-->
                  </div>
                ...
                <div class="row">
                  <div class="col-xl-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text"
                        class="form-control form-control-solid h-auto py-7 px-6 border-0 rounded-lg font-size-h6"
                        name="state" placeholder="State" value="" id="state" />
              ...
              <div class="pb-5" data-wizard-type="step-content">
                ...
                <div class="text-dark-50 font-weight-bold line-height-lg mb-8" id="submit_section_1">
                  <div id="name"></div>
                ...
                <div class="text-dark-50 font-weight-bold line-height-lg mb-8" id="submit_section_2">
                  <div id="addr1"></div>
                  <div id="addr2"></div>
              ...
              <div class="d-flex justify-content-between pt-7">
                <div class="mr-2">
                  <button type="button"
                    ...
                    <span class="svg-icon svg-icon-md mr-2">
                      <!--begin::Svg Icon | path:assets/dist/ass/media/svg/icons/Navigation/Left-2.svg-->
                      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                        height="24px" viewBox="0 0 24 24" version="1.1">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                          <polygon points="0 0 24 0 24 24 0 24" />
                ...
                <div>
                  <button class="btn btn-primary font-weight-bolder font-size-h6 pl-8 pr-4 py-4 my-3"
                    data-wizard-type="action-submit" type="submit" id="kt_login_signup_form_submit_button">Submit
                    <span class="svg-icon svg-icon-md ml-2">
                      <!--begin::Svg Icon | path:assets/dist/ass/media/svg/icons/Navigation/Right-2.svg-->
                      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                        height="24px" viewBox="0 0 24 24" version="1.1">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                          <polygon points="0 0 24 0 24 24 0 24" />
                  ...
                  <button type="button" class="btn btn-primary font-weight-bolder font-size-h6 pl-8 pr-4 py-4 my-3"
                    data-wizard-type="action-next" id="next">Next
                    <span class="svg-icon svg-icon-md ml-2">
                      <!--begin::Svg Icon | path:assets/dist/ass/media/svg/icons/Navigation/Right-2.svg-->
                      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                        height="24px" viewBox="0 0 24 24" version="1.1">
      ...
      <div class="login-aside order-1 order-lg-2 bgi-no-repeat bgi-position-x-right">
        <div class="login-conteiner bgi-no-repeat bgi-position-x-right bgi-position-y-bottom"
          style="background-image: url(assets/dist/assets/media/svg/illustrations/login-visual-4.svg);">
          <!--begin::Aside title-->
          <h3
  ...
  <script src="assets/dist/assets/js/pages/custom/login/login-4.js"></script>
  <script src="assets/js/user/sign-up.js"></script>
  <!--end::Page Scripts-->
</body>
<!--end::Body-->
