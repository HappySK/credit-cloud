...
<body id="kt_body"
      ...
      <div
        ...
        <div class="login-content d-flex flex-column pt-lg-0 pt-12">
          ...
          <div class="login-form">
            <!--begin::Form-->
            <form class="form" id="kt_login_singin_form" action="server-side/user-log.php?action=login">
              <!--begin::Title-->
              <div class=" pb-5 pb-lg-15">
                <h3 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">Sign In</h3>
                <div class="text-muted font-weight-bold font-size-h4">New Here?
                  <a href="user/sign-up" class="text-primary font-weight-bolder">Create
                    Account</a>
                </div>
              </div>
              <!--begin::Title-->
              ...
              <div class="form-group">
                <div class="d-flex justify-content-between mt-n5">
                  ...
                  <a href="user/forgot-password"
                    class="text-primary font-size-h6 font-weight-bolder text-hover-primary pt-5">Forgot Password ?</a>
                </div>
              ...
              <div class="pb-lg-0 pb-5">
                ...
                <button type="button" class="btn btn-light-primary font-weight-bolder px-8 py-4 my-3 font-size-lg">
                  <span class="svg-icon svg-icon-md">
                    <!--begin::Svg Icon | path:assets/assets/media/svg/social-icons/google.svg-->
  ...
  <script src="assets/plugins/sign-in-validate.js"></script>
  <script src="assets/js/user/sign-in.js"></script>
  <!--end::Page Scripts-->
</body>
<!--end::Body-->
