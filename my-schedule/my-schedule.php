...
<?php 
  ...
  session_start(); 
>>>>>>> a1d324699bc67e34afe36b8472469b1105dfde21
              ...
              <div class="card card-custom">
                <div class="card-header">
                  ...
                  <div class="card-toolbar d-flex justify-content-around w-25">
                    <a href="#add-event-modal" data-toggle="modal" class="btn btn-light-primary font-weight-bold">
                  ...
                  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="add-event-title">Modal Title</h5>
                      ...
                      <div class="modal-body" style="height: 300px;">
                        <div class="form-group">
                          <label for="event-type" class="form-control-label">Event Type</label>
                          <select name="event-type" id="event-type" class="custom-select">
                        ...
                        <div class="form-group">
                          <label for="event-subject" class="form-control-label">Event Subject</label>
                          <input type="text" name="event-subject" id="event-subject" class="form-control">
                        </div>
                        <div class="form-group form-inline d-flex justify-content-around">
                          ...
                          <select name="start-time" id="start-time" class="custom-select">
                            <option value="T12:00:00">12:00 am</option>
                            <option value="T12:30:00">12:30 am</option>
                            <option value="T01:00:00">1:00 am</option>
                            <option value="T01:30:00">1:30 am</option>
                            <option value="T02:00:00">2:00 am</option>
                            <option value="T02:30:00">2:30 am</option>
                            <option value="T03:00:00">3:00 am</option>
                            <option value="T03:30:00">3:30 am</option>
                            <option value="T04:00:00">4:00 am</option>
                            <option value="T04:30:00">4:30 am</option>
                            <option value="T05:00:00">5:00 am</option>
                            <option value="T05:30:00">5:30 am</option>
                            <option value="T06:00:00">6:00 am</option>
                            <option value="T06:30:00">6:30 am</option>
                            <option value="T07:00:00">7:00 am</option>
                            <option value="T07:30:00">7:30 am</option>
                            <option value="T08:00:00">8:00 am</option>
                            <option value="T08:30:00">8:30 am</option>
                            <option value="T09:00:00">9:00 am</option>
                            <option value="T09:30:00">9:30 am</option>
                            ...
                            <option value="T13:00:00">1:00 pm</option>
                            <option value="T13:30:00">1:30 pm</option>
                            <option value="T14:00:00">2:00 pm</option>
                            <option value="T14:30:00">2:30 pm</option>
                            <option value="T15:00:00">3:00 pm</option>
                            <option value="T15:30:00">3:30 pm</option>
                            <option value="T16:00:00">4:00 pm</option>
                            <option value="T16:30:00">4:30 pm</option>
                            <option value="T17:00:00">5:00 pm</option>
                            <option value="T17:30:00">5:30 pm</option>
                            <option value="T18:00:00">6:00 pm</option>
                            <option value="T18:30:00">6:30 pm</option>
                            <option value="T19:00:00">7:00 pm</option>
                            <option value="T19:30:00">7:30 pm</option>
                            <option value="T20:00:00">8:00 pm</option>
                            <option value="T20:30:00">8:30 pm</option>
                            <option value="T21:00:00">9:00 pm</option>
                            <option value="T21:30:00">9:30 pm</option>
                        ...
                        <div class="form-group form-inline d-flex justify-content-around">
                          ...
                          <select name="end-time" id="end-time" class="custom-select">
                            <option value="T12:00:00">12:00 am</option>
                            <option value="T12:30:00">12:30 am</option>
                            <option value="T01:00:00">1:00 am</option>
                            <option value="T01:30:00">1:30 am</option>
                        ...
                        <div class="form-group">
                          ...
                          <select name="client-name" id="client-name" class="custom-select">
                            <option value="">Client</option>
                          </select>
                        </div>
                        <div class="form-group">
                          <label for="team-member-name" class="form-control-label">Team Member</label>
                          <select name="team-member-name" id="team-member-name" class="custom-select">
                            <option value="">Team Member Name</option>
                          </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <textarea name="remark" id="remarks" class="form-control"></textarea>
                        </div>
                      </div>
                      <div class="modal-footer">
                        <button type="button" class="btn btn-light-primary font-weight-bold"
                          data-dismiss="modal">Close</button>
                        <button type="button" class="btn btn-primary font-weight-bold" id="save-button">Save
                        </button>
                      </div>
                    </div>
                  </div>
