...
<head>
  <base href="../">
  <meta charset="utf-8" />
  <title><?= TITLE ?> | Dispute Options</title>
            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
              ...
              <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                  <!--begin::Page Title-->
                  <h5 class="text-dark font-weight-bold my-1 mr-5">Dispute Options</h5>
                  <!--end::Page Title-->
                  <!--begin::Breadcrumb-->
                  <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                      <a href="" class="text-muted">Dispute Options</a>
                    </li>
                  </ul>
                  <!--end::Breadcrumb-->
                </div>
            ...
            <div class="container">
              <div class="card">
                <div class="card-header">
                  <h5>Manage Dispute Reasons and Instructions</h5>
                </div>
                <div class="card-body pt-0">
                  <!--begin::Notice-->
                  <div class="alert alert-custom alert-white alert-shadow gutter-b m-3 bg-light" role="alert">
                    <div class="alert-text">
                      Add, remove or modify the dispute reasons and instructions that appear as choices in the Dispute
                      Wizard. Add as many as you like. The only ones you cannot delete or modify are the defaults.
                    </div>
                  </div>
                  <!--end::Notice-->
                  ...
                  <div class="alert alert-custom alert-white alert-shadow gutter-b m-3 bg-light" role="alert">
                    <div class="alert-text">
                      Batch Print enables you to print all pending letters for all your clients at one time, a huge time
                      saver if you have many clients.
                    </div>
                  </div>
                  <!--end::Notice-->
                  ...
                  <div class="alert alert-custom alert-white alert-shadow gutter-b m-3 bg-light" role="alert">
                    <div class="alert-text">
                      <strong>Note:</strong> please upload only jpg, jpeg, gif, bmp or png file and dimensions of 100 X
                      20. If you are in the USA, we recommend that you do not make any changes to this page.
                    </div>
                  </div>
                  <!--end::Notice-->
