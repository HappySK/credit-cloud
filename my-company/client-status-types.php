...
<head>
  <base href="../">
  <meta charset="utf-8" />
  <title><?= TITLE ?> | Client Status Types</title>
...
<body id="kt_body"
            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
              ...
              <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                  <!--begin::Page Title-->
                  <h5 class="text-dark font-weight-bold my-1 mr-5">Client Status Types</h5>
                  <!--end::Page Title-->
                  <!--begin::Breadcrumb-->
                  <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    <li class="breadcrumb-item">
                      <a href="my-company/company-profile" class="text-muted">My Company</a>
                    </li>
                    <li class="breadcrumb-item">
                      <a href="" class="text-muted">Client Status Types</a>
                    </li>
                  </ul>
                  <!--end::Breadcrumb-->
                </div>
                ...
                <div class="card-body pt-0">
                  ...
                  <div class="alert alert-custom alert-white alert-shadow gutter-b m-3 bg-light" role="alert">
                    <div class="alert-text">
                      Listed below are the status types that can be assigned to your clients. Very few users will ever
                      need to use this page, but instructions are below for advanced users with a special need to create
                      custom status types with different login privileges. *Please note: default status types are locked
                      and cannot be changed.
                    </div>
                  </div>
                  <!--end::Notice-->
                  <div class="form-group row align-items-center">
                    <label for="add-status" class="col-lg-1 col-sm-6">
                      <strong>Add Status</strong>
                    </label>
                    <input type="text" name="add-status" id="add-status"
                      class="form-control form-control-solid col-lg-2 col-sm-6">
                    <label for="allow-login" class="col-lg-2 col-sm-6">
                      <strong>Allow Login</strong>
                    </label>
                    <select name="allow-login-select" id="allow-login-select" class="custom-select col-lg-2 col-sm-12">
                      <option value="Yes">Yes</option>
                      <option value="No">No</option>
                    </select>
                    <label for="color" class="col-lg-1 col-sm-6">
                      <strong>Color</strong>
                    </label>
                  ...
                  <div class="form-group">
                    <h6>Client Status counted as clients</h6>
                    <p>These statuses do not allow you to do work on client</p>
                  </div>
                  <table class="table table-hoverable" id="not-counted-as-clients-table">
                    <thead>
                      <tr>
                        <th>Status Name</th>
                        <th>Total in Status</th>
                        <th>Allow Portal Login</th>
                        <th>Color</th>
                        <th>Actions</th>
                      </tr>
                    </thead>
                  </table>
                  <p>Total contacts not counted as client: <span id="not-counted-as-client-total"></span></p>
                  <h6>Status Counted as Clients</h6>
                  <p>These statuses allow you to do work on client</p>
                  <table class="table table-hoverable" id="counted-as-clients-table">
                    <thead>
                      <tr>
                        <th>Status Name</th>
                        <th>Total in Status</th>
                  ...
                  <h6>Client Slots Used <span id="client-slots"></span></h6>
                  <!--begin::Notice-->
                  <div class="alert alert-custom alert-white alert-shadow gutter-b m-3" role="alert">
                    ...
                    <div class="alert-text">
                      <p>
                        The default client status types are Lead, Prospect, Client and Inactive. When a new Lead arrives
                        in your account, the status is Lead. When you communicate with a Lead, change the status to
                        Prospect. When a Prospect signs up for service, he becomes a Client. When you stop working with
                        a Client, you can either delete the Client (from the Client List) or set their status as
                        Inactive. If a Client doesn't pay his bill, set the status to Suspended. The default status
                        types cannot be modified, but you may add additional statuses here. Change a client's status in
                        their Client Profile, the Client List or through the API.
                      </p>
                      <p>
                        User plans have a limit of active clients. Leads, prospects and suspended clients are never
                        counted. Any other status (including custom statuses) are counted as “active clients.” When you
                        finish working with a client, delete them or mark them as suspended.
                      </p>
                    </div>
                  </div>
                  <!--end::Notice-->
  ...
  <script src="assets/js/my-company/client-status-types.js"></script>
  <!--end::Page Scripts-->
</body>
<!--end::Body-->
