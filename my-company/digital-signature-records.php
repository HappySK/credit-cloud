...
<head>
  <base href="../">
  <meta charset="utf-8" />
  <title><?= TITLE ?> | Digital Signature Records</title>
...
<body id="kt_body"
            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
              ...
              <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                  <!--begin::Page Title-->
                  <h5 class="text-dark font-weight-bold my-1 mr-5">Digital Signature Records</h5>
                  <!--end::Page Title-->
                  <!--begin::Breadcrumb-->
                  <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                      <a href="" class="text-muted">Digital Signature Records</a>
                    </li>
                  </ul>
                  <!--end::Breadcrumb-->
                </div>
            ...
            <div class="container">
              <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                  <h5>Digital Signature Records</h5>
                ...
                <div class="card-body">
                  ...
                  <div class="alert alert-custom alert-white alert-shadow gutter-b m-3 bg-light" role="alert">
                    <div class="alert-text">
                      When you assign an online client agreement during creation of a new client's profile, that client
                      cannot log into <a href="#">secureclientaccess.com</a> until they sign and agree. All signed
                      online agreements are
                      stored below with signature, IP and timestamp. If a client is not listed, they have not signed
                      your agreement. You can check status of client logins and outstanding agreements on your
                      <a href="#">My Clients</a> page.
                    </div>
                  </div>
                  <!--end::Notice-->
                  <table class="table table-hoverable" id="digital-signature-records-table">
                    <thead>
                      <tr>
                        <th>Name</th>
                        <th>Email</th>
                  ...
                  <div class="alert alert-custom alert-white alert-shadow gutter-b m-3" role="alert">
                    ...
                    <div class="alert-text">
                      ...
                      legal effects as traditional paper documents and handwritten signatures. Read more at the FTC web
                      site: <a href="#">http://www.ftc.gov/os/2001/06/esign7.htm</a>
                    </div>
                  </div>
                  <!--end::Notice-->
                </div>
  ...
  <script src="assets/js/my-company/digital-signature-records.js"></script>
  <!--end::Page Scripts-->
</body>
<!--end::Body-->
