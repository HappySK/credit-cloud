...
<body id="kt_body"
          ...
          <div class="d-flex flex-column-fluid">
            ...
            <div class="container">
              <div class="card">
                ...
                <div class="card-body">
                  <form class="form" action="super-admin/update-role.php" method="POST">
                    <div class="form-group">
                      ...
                      <select name="select-user" id="select-user" data-flip="false" class="custom-select">
                        ...
                        <?php 
                          ...
                          {
                        ?>
                        <option value="<?= $user_details['user_id'] ?>">
                    ...
                    <div class="form-group">
                      ...
                      <select name="select-role" id="select-role" data-flip="false" class="custom-select">
                        <option value="">Select Role</option>
                        <?php
                          $role_data = $admin->get_roles(); 
                          foreach($role_data as $role_id => $role)
                          {
                        ?>
  ...
  <script src="assets/js/super-admin/super-admin-dashboard.js"></script>
  <!--end::Page Scripts-->
</body>
<!--end::Body-->
