...
<head>
  ...
  <link href="assets/dist/assets/css/pages/login/classic/login-3.css" rel="stylesheet" type="text/css" />
...
<body id="kt_body"
  ...
  <div class="d-flex flex-column flex-root">
    ...
    <div class="login login-3 login-signin-on d-flex flex-row-fluid" id="kt_login">
      <div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid"
        style="background-image: url(assets/dist/assets/media/bg/bg-1.jpg);">
        <div class="login-form text-center text-white p-7 position-relative overflow-hidden">
          <!--begin::Login Header-->
          <div class="d-flex flex-center mb-15">
            <a href="#">
              <img src="assets/dist/assets/media/logos/logo-letter-9.png" class="max-h-100px" alt="" />
            </a>
          </div>
          <!--end::Login Header-->
            ...
            <form class="form" id="kt_login_signin_form" method="POST">
              <div class="form-group">
                <input
                  ...
                  type="text" placeholder="Email" name="username" id="username" autocomplete="off" />
              </div>
              <div class="form-group">
                <input
                  class="form-control h-auto text-white placeholder-white opacity-70 bg-dark-o-70 rounded-pill border-0 py-4 px-8 mb-5"
  ...
  <!-- <script src="assets/dist/assets/js/pages/custom/login/login-general.js"></script> -->
  <script src="assets/js/super-admin/super-admin-login.js"></script>
  <!--end::Page Scripts-->
</body>
<!--end::Body-->
