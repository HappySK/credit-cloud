            ...
            <div class="container-fluid">
              ...
              <div class="alert alert-custom alert-white alert-shadow gutter-b m-3" role="alert">
                ...
                <div class="alert-text">
                  You have a full account with all access! Get started with the <a href="#">Weclome Video</a>, the
                  <a href="#">Guided Tour</a> and
                  learn
                  with your <a href="#">Sample Client</a>. Be sure to read our <a href="#">User Guides</a>. For the
                  best possible experience, <a href="#">tune-up your web browser</a>. For account changes
                  <a href="#">Click Here</a>.
                  Need help? See
                  <a href="#">help and support options</a>.
                </div>
              </div>
              <!--end::Notice-->
              <div class="container">
                ...
                <div class="card card-custom gutter-b m-4">
                  ...
                  <div class="card-body w-100">
                    ...
                    {
                    ?>
                    The Login Activity wont be displayed until you <a href="user/sign-in">Sign In</a>
                    <?php
                    }
                    ?>
                  </div>
