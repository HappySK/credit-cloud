              ...
              <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                  ...
                  <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                      <a href="add-client" class="text-muted">Add Client</a>
                    </li>
                  </ul>
                  <!--end::Breadcrumb-->
                </div>
                ...
                <div class="card-body">
                  <div class="card-title d-flex justify-content-between">
                    ...
                    <div>
                      ...
                      <a href="my-clients/clients-list" class="btn btn-sm btn-outline-success">
                  ...
                  <div class="bg-light alert alert-custom alert-white alert-shadow gutter-b m-3" role="alert">
                    ...
                    <div class="alert-text">
                      Add a new client and grant them portal access. Each client must have a unique User ID and email
                      address that are
                      not shared by any other user system-wide. If a married couple wish to share 1 email, they must
                      each have their
                      own unique User ID. Got your first client and wondering what to do next? <a href="#">Click
                        Here</a>.
                    </div>
                  </div>
                  <!--end::Notice-->
