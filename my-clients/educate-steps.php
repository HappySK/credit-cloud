...
<body id="kt_body"
            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
              ...
              <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                  <!--begin::Page Title-->
                  <h5 class="text-dark font-weight-bold my-1 mr-5">Educate</h5>
                  <!--end::Page Title-->
                  <!--begin::Breadcrumb-->
                  <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    <li class="breadcrumb-item">
                      <a href="my-clients/edit-client-details?tab=educate" class=" text-muted">Educate</a>
                    </li>
                  </ul>
                  <!--end::Breadcrumb-->
                </div>
                  ...
                  <div class="tab-content m-4" id="nav-tabContent">
                      ...
                      <div class="card-deck m-2">
                        <div class="card bg-light">
                          <div class="card-header">
                            <h6>Client's Debts</h6>
                          </div>
                          <div class="card-body">
                            <p>
                              If your client carries high credit card (revolving) debt, they should be aware of what
                              their finance (APR) charges are for each account and you might want to suggest that they
                              focus on paying down the accounts with the highest interest (APR) rate first. This will
                              save them the most money.
                            </p>
                            <p>
                              A higher FICO score will qualify your client for a lower interest rate (APR). Maxing out
                              credit cards looks bad to the Credit Bureaus and lowers a credit score. If your clients
                              carry high credit card balances, here is a trick that will often boost a score
                              considerably (and quickly); Instruct the client to pay all of their credit cards down to
                              where the balance owed (B2AC) is below 25-30% of the available limit.
                            </p>
                            <p>
                              In this form on the right, enter the client’s account balances, credit limits and APR
                              interest rates. It will calculate their total debt and and "balance-to-available-limit"
                              (B2AC) ratio, to show what they need to focus on for maximum results.
                            </p>
                            <p>
                              To maximize a score, instruct your client to keep their "balance-to-available-limit" ratio
                              below 25-30%.
                            </p>
                        ...
                        <div class="card bg-light">
                          <div class="card-header">
                            <h6>Client's Credit Accounts</h6>
                          </div>
                          <div class="card-body">
                            ...
                            <table class="table-hover table table-responsive" cellspacing="0" cellpadding="0">
                              <thead>
                                <tr>
                                  <th>Account / Card</th>
                                  <th>APR</th>
                              ...
                              <tbody>
                                ...
                                <tr>
                                  <td colspan="2" class="text-danger">
                                    * B2AC = Balance to Available Credit
                                  </td>
                                  <td>
                                    Limit
                                  </td>
                        ...
                        <div class="card-body">
                          ...
                          <div class="card-deck">
                            <div class="card bg-light">
                              ...
                              <div class="card-body">
                                <p>
                                  For 30 days have your clients write down what they spend each day. This will show them
                                  very clearly where they can cut back.
                                </p>
                                <div class="d-inline">
                                  <label for="daily-expense-date" class="custom-label">
                                    Choose a date with this
                                    calendar
                                  </label>
                                  <input type="date" name="daily-expenses-date" id="daily-expenses-date"
                                    class="form-control">
                                </div>
                                <table class="table table-hover">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      <td>
                                        <input type="text" name="daily-expenses-<?= $i ?>" id="daily-expenses-<?= $i ?>"
                                          class="form-control" placeholder="Enter your daily expeneses" />
                                      </td>
                                      <td>
                                        <input type="number" name="amount-<?= $i ?>" id="amount-<?= $i ?>"
                                          class="form-control sum" value="0">
                                      </td>
                                    </tr>
                                    <?php } ?>
                                    <tr>
                                      ...
                                      <td>
                                        <input type="number" name="amount-last" id="total-amount" class="form-control"
                                          value="0">
                                      </td>
                                    </tr>
                                    <tr>
                            ...
                            <div class="card bg-light">
                              ...
                              <div class="card-body">
                                <div class="form-inline d-flex justify-content-around">
                                  <select name="monthly-expenses-month" id="monthly-expenses-month"
                                    class="custom-select">
                                    <option value="">Select Month</option>
                                    <option value="January">January</option>
                                    <option value="February">February</option>
                                  ...
                                  <select name="monthly-expenses-year" id="monthly-expenses-year" class="custom-select"
                                    data-flip="false">
                                    <option value="">Select Year</option>
                                    <?php for($i = 2000; $i <= date("Y") ; $i++) { ?>
                                    <option value="<?= $i ?>">
                                  ...
                                  <button class="btn btn-sm btn-outline-primary" id="month-year-submit">Submit</button>
                                </div>
                                <div class="form-group">
                                  <table class="table table-hover mt-2">
                                    <tbody>
                                      <tr>
                                        <td class=" align-middle">Auto : Fuel</td>
                                        <td>
                                          <input type="text" name="auto-fuel" id="auto-fuel"
                                            class="form-control monthly-expenses-fields" value="0">
                                        </td>
                                      </tr>
                                      <tr>
                                        <td class="align-middle">Auto : Insurance</td>
                                        <td>
                                          <input type="text" name="auto-insurance" id="auto-insurance"
                                            class="form-control monthly-expenses-fields" value="0">
                                        </td>
                                      </tr>
                                      <tr>
                                        <td class="align-middle">Auto : Maintainence / Repairs</td>
                                        <td>
                                          <input type="text" name="auto-maintainence-repairs"
                                            id="auto-maintainence-repairs" class="form-control monthly-expenses-fields"
                                            value="0">
                                        </td>
                                      </tr>
                                      <tr>
                                        <td class="align-middle">Auto : Payment</td>
                                        <td>
                                          <input type="text" name="auto-payment" id="auto-payment" mo
                                            class="form-control monthly-expenses-fields" value="0">
                                        </td>
                                      </tr>
                                      <tr>
                                        <td class="align-middle">Cable / Satellite</td>
                                        <td>
                                          <input type="text" name="cable-satellite" id="cable-satellite" mo
                                            class="form-control monthly-expenses-fields" value="0">
                                        </td>
                                      </tr>
                                      <tr>
                                        <td class="align-middle">Cell Phone</td>
                                        <td>
                                          <input type="text" name="celmol-phone" id="cell-phone"
                                            class="form-control monthly-expenses-fields" value="0">
                                        </td>
                                      </tr>
                                      <tr>
                                        <td class="align-middle">Child Support Animoly</td>
                                        <td>
                                          <input type="text" name="child-support-animoly" id="child-support-animoly" mo
                                            class="form-control monthly-expenses-fields" value="0">
                                        </td>
                                      </tr>
                                      <tr>
                                        <td class="align-middle">Child Care</td>
                                        <td>
                                          <input type="text" name="chimold-care" id="child-care"
                                            class="form-control monthly-expenses-fields" value="0">
                                        </td>
                                      </tr>
                                      <tr>
                                        <td class="align-middle">Cigarettes / Alcohol</td>
                                        <td>
                                          <input type="text" name="cigarettes-alcohol" id="cigarettes-alcohol" mo
                                            class="form-control monthly-expenses-fields" value="0">
                                        </td>
                                      </tr>
                                      <tr>
                                      ...
                                      <tr>
                                        <td class="align-middle">Credit Card / Charge Card</td>
                                        <td>
                                          <input type="text" name="credit-card-charge-card" id="credit-card-charge-card"
                                            class="form-control monthly-expenses-fields" value="0">
                                        </td>
                                      </tr>
                                      <tr>
                                        <td class="align-middle">Dining</td>
                                        <td>
                                          <input type="text" nmoame="dining" id="dining"
                                            class="form-control monthly-expenses-fields" value="0">
                                        </td>
                                      </tr>
                                      <tr>
                                        <td class="align-middle">Doctor Prescriptions</td>
                                        <td>
                                          <input type="text" name="doctor-prescriptions" id="doctor-prescriptions" mo
                                            class="form-control monthly-expenses-fields" value="0">
                                        </td>
                                      </tr>
                                      <tr>
                                        <td class="align-middle">Education Expenses</td>
                                        <td>
                                          <input type="text" name="education-expenses" id="education-expenses" mo
                                            class="form-control monthly-expenses-fields" value="0">
                                        </td>
                                      </tr>
                                      <tr>
                                        <td class="align-middle">Electric Bill</td>
                                        <td>
                                          <input type="text" name="electric-bill" id="electric-bill" mo
                                            class="form-control monthly-expenses-fields" value="0">
                                        </td>
                                      </tr>
                                      <tr>
                                        <td class="align-middle">Entertainment</td>
                                        <td>
                                          <input type="text" name="entertainment" id="entertainment" mo
                                            class="form-control monthly-expenses-fields" value="0">
                                        </td>
                                      </tr>
                                      <tr>
                                        <td class="align-middle">Gas Bill</td>
                                        <td>
                                          <input type="text" name="gas-bill" id="gas-bill"
                                            class="form-control monthly-expenses-fields" value="0">
                                        </td>
                                      </tr>
                                      <tr>
                                        <td class="align-middle">Gifts</td>
                                        <td>
                                          <input type="text" mo name="gifts" id="gifts"
                                            class="form-control monthly-expenses-fields" value="0">
                                        </td>
                                      </tr>
                                      <tr>
                                        <td class="align-middle">Groceries / Suppliers</td>
                                        <td>
                                          <input type="text" name="groceries-suppliers" id="groceries-suppliers" mo
                                            class="form-control monthly-expenses-fields" value="0">
                                        </td>
                                      </tr>
                                      <tr>
                                        <td class="align-middle">Hobbies / Clubs / Sports</td>
                                        <td>
                                          <input type="text" name="hobbies-clubs-sports" id="hobbies-clubs-sports" mo
                                            class="form-control monthly-expenses-fields" value="0">
                                        </td>
                                      </tr>
                                      <tr>
                                        <td class="align-middle">Home Maintainence</td>
                                        <td>
                                          <input type="text" name="home-maintainence" id="home-maintainence" mo
                                            class="form-control monthly-expenses-fields" value="0">
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td>
                                          <input type="text" name="imonsurance" id="insurance"
                                            class="form-control monthly-expenses-fields" value="0">
                                        </td>
                                      </tr>
                                      <tr>
                                        <td class="align-middle">Internet Service</td>
                                        <td>
                                          <input type="text" name="internet-service" id="internet-service" mo
                                            class="form-control monthly-expenses-fields" value="0">
                                        </td>
                                      </tr>
                                      <tr>
                                        <td class="align-middle">Local Payment</td>
                                        <td>
                                          <input type="text" name="local-payment" id="local-payment" mo
                                            class="form-control monthly-expenses-fields" value="0">
                                        </td>
                                      </tr>
                                      <tr>
                                        <td class="align-middle">Newspapers / Magazines</td>
                                        <td>
                                          <input type="text" name="newspapers-magazines" id="newspapers-magazines" mo
                                            class="form-control monthly-expenses-fields" value="0">
                                        </td>
                                      </tr>
                                      <tr>
                                        <td class="align-middle">Rent / Mortgages Payments</td>
                                        <td>
                                          <input type="text" name="rent-mortgages-payment" id="rent-mortgages-payment"
                                            mo class="form-control monthly-expenses-fields" value="0">
                                        </td>
                                      </tr>
                                      <tr>
                                        <td class="align-middle">Taxes</td>
                                        <td>
                                          <input type="text" mo name="taxes" id="taxes"
                                            class="form-control monthly-expenses-fields" value="0">
                                        </td>
                                      </tr>
                                      <tr>
                                      ...
                                      <tr>
                                        <td class="align-middle">Work Expenses</td>
                                        <td>
                                          <input type="text" name="work-expenses" id="work-expenses"
                                            class="form-control monthly-expenses-fields" value="0">
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td>
                                          <input type="number" name="total" id="monthly-expenses-total"
                                            class="form-control" value="0">
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
                                  <button class="btn btn-sm btn-outline-primary" id="save-button">Save</button>
                                </div>
                              </div>
                            </div>
                          </div>
                    ...
                    <div class="tab-pane fade <?php if($_GET['tab'] == 'calculators') echo 'show active';?>"
                      ...
                      <div class="card bg-light">
                        <div class="card-body">
                          <div class="card-title">
                            Calculators (Client Name)
                          </div>
                          <div class="card-deck">
                            <div class="card">
                              <div class="card-body">
                                <div class="card-title">
                                  <h5>STANDARD CALCULATOR</h5>
                                </div>
                                <table>
                                  <td>
                            ...
                            <div class="card">
                              <div class="card-body">
                                <div class="card-title">
                                  <h5>Saving Calculator</h5>
                                </div>
                                <form action="">
                                  <div class="form-group">
                                    <label for="enter-amount">Enter Amount</label>
                                    <input type="text" name="enter-amount" id="enter-amount" class="form-control">
                                  </div>
                                  <div class="form-group">
                                    <label for="savings">I've Already Saved</label>
  ...
  <script src="assets/js/educate/educate.js"></script>
</body>
<!--end::Body-->
