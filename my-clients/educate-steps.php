                                ...
                                <table class="table table-hover">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <input type="number" name="amount-last" id="amount-last" class="form-control">
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
                                  ...
                                  <table class="table table-hover mt-2">
                                    <tbody>
                                      <tr>
                                        ...
                                        <td>
                                          <input type="text" name="auto-fuel" id="auto-fuel" class="form-control">
                                        </td>
                                      </tr>
                                      <tr>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <input type="text" name="auto-maintainence-repairs"
                                            id="auto-maintainence-repairs" class="form-control">
                                        </td>
                                      </tr>
                                      <tr>
                                        <td class="align-middle">Auto : Payment</td>
                                        <td>
                                          <input type="text" name="auto-payment" id="auto-payment" class="form-control">
                                        </td>
                                      </tr>
                                      <tr>
                                        <td class="align-middle">Cable / Satellite</td>
                                        <td>
                                          <input type="text" name="cable-satellite" id="cable-satellite"
                                            class="form-control">
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td>
                                          <input type="text" name="cell-phone" id="cell-phone" class="form-control">
                                        </td>
                                      </tr>
                                      <tr>
                                        <td class="align-middle">Child Support Animoly</td>
                                        <td>
                                          <input type="text" name="child-support-animoly" id="child-support-animoly"
                                            class="form-control">
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td>
                                          <input type="text" name="child-care" id="child-care" class="form-control">
                                        </td>
                                      </tr>
                                      <tr>
                                        <td class="align-middle">Cigarettes / Alcohol</td>
                                        <td>
                                          <input type="text" name="cigarettes-alcohol" id="cigarattes-alcohol"
                                            class="form-control">
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td>
                                          <input type="text" name="clothing" id="clothing" class="form-control">
                                        </td>
                                      </tr>
                                      <tr>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <input type="text" name="dining" id="dining" class="form-control">
                                        </td>
                                      </tr>
                                      <tr>
                                        <td class="align-middle">Doctor Prescriptions</td>
                                        <td>
                                          <input type="text" name="doctor-prescriptions" id="doctor-prescriptions"
                                            class="form-control">
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td>
                                          <input type="text" name="education-expenses" id="education-expenses"
                                            class="form-control">
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td>
                                          <input type="text" name="electric-bill" id="electric-bill"
                                            class="form-control">
                                        </td>
                                      </tr>
                                      <tr>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <input type="text" name="gas-bill" id="gas-bill" class="form-control">
                                        </td>
                                      </tr>
                                      <tr>
                                        <td class="align-middle">Gifts</td>
                                        <td>
                                          <input type="text" name="gifts" id="gifts" class="form-control">
                                        </td>
                                      </tr>
                                      <tr>
                                        <td class="align-middle">Groceries / Suppliers</td>
                                        <td>
                                          <input type="text" name="groceries-suppliers" id="groceries-suppliers"
                                            class="form-control">
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td>
                                          <input type="text" name="hobbies-clubs-sports" id="hobbies-clubs-sports"
                                            class="form-control">
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td>
                                          <input type="text" name="home-maintainence" id="home-maintainence"
                                            class="form-control">
                                        </td>
                                      </tr>
                                      <tr>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <input type="text" name="internet-service" id="internet-service"
                                            class="form-control">
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td>
                                          <input type="text" name="local-payment" id="local-payment"
                                            class="form-control">
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td>
                                          <input type="text" name="newspapers-magazines" id="newspapers-magazines"
                                            class="form-control">
                                        </td>
                                      </tr>
                                      <tr>
