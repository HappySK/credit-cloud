              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="radio-inline m-3 collapse show top-bottom-collapse">
                    ...
                    <label class="radio" data-toggle="collapse" data-target=".round-2, .c-paragraph">
                      <input type="radio" name="rounds" id="round-1" checked />
                      <span></span>
                      Round 1: Basic Dispute (Credit Bureaus)
                    </label>
                    <label class="radio">
                      <input type="radio" name="rounds" id="round-2" data-toggle="collapse"
                        data-target=".round-2, .c-paragraph" />
                      <span></span>
                  ...
                  <div class="d-flex justify-content-start m-3 align-items-center">
                    ...
                    <div class="collapse hide radio-inline round-2">
                      <label class="radio ml-2">
                        Who is this letter to :
                      </label>
                      <label class="radio">
                        <input type="radio" name="credit-letter" id="credit-report" />
                        <span></span>
                        Credit Bureau
                      </label>
                      <label class="radio">
                        <input type="radio" name="credit-letter" id="credit-report" />
                        <span></span>
                        Creditor/Furnisher who reported to them
                      </label>
                    </div>
                    <div class="">
                  ...
                  <div class="collapse hide top-bottom-collapse">
                    ...
                    <div class="button-group d-flex justify-content-around m-3">
                      ...
                      <button data-toggle="collapse" data-target=".top-bottom-collapse,.table-collapse"
                  ...
                  <div class="collapse show top-bottom-collapse">
                    <div class="d-flex justify-content-start align-items-center pl-2 pr-2">
                      <div>
                        <img src="https://app.creditrepaircloud.com/application/images/c_blue_big.png" alt="Image A"
                          class="m-2">
                      </div>
                      <strong class="collapse show c-paragraph">
                      ...
                      <div class="collapse hide radio-inline c-paragraph">
                        <label class="radio ml-2">
                        ...
                        <label class="radio">
                          <input type="radio" name="credit-letter" id="credit-report" />
                          <span></span>
                          Use New letter finder tool (Guided Mode)
                        </label>
                        <label class="radio">
                          <input type="radio" name="credit-letter" id="credit-report" />
                          <span></span>
                          Choose a letter from library (Expert Mode)
                        </label>
                      </div>
                    </div>
                  </div>
