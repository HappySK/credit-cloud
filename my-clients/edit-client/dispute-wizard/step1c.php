            ...
            <div class="container">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p>
                    You are entitled to one free credit report per year from each of big three credit bureaus (Equifax,
                    Experian and Transunion) via their "Annual Credit Report Request Service." You are also entitled to
                    free reports if you've been denied credit within the past 30 days, if you believe you are a victim
                    of fraud, or if you are undergoing a hardship (see below). If you are not eligible for a free
                    report, the fee ranges from $0-10 depending on what state you reside in. Visit the Credit Bureau web
                    sites (see LINKS) or call them (CONTACTS) to find the exact prices for your state.
                  </p>
                  <h6 class="mt-3 mb-3">Fill out the from below to request Credit History Reports directly from the
                    Credit
                    Bureaus</h6>
                  <div class="d-flex justify-content-around my-4">
                    <h6>Select Credit Bureaus</h6>
                    <div>
                  ...
                  <div>
                    <div class="form-inline">
                      ...
                      <label for="1" class="m-3">
                        ...
                        by
                        <input type="text" class="m-3 form-control">
                        enclosed is a copy of the rejection
                        letter
                      </label>
                    </div>
                    <div class="form-inline">
                  ...
                  <p class="mt-5 mb-5">
                    *Please don't contact us about credit reports or scores. Scores are purchased directly from the
                    credit bureaus or third-party services. We are not affiliated with the credit bureaus and we cannot
